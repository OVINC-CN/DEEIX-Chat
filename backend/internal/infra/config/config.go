...
const (
	defaultAppName                      = "OVINC Chat"
	defaultBrandTitle                   = "OVINC Chat"
	defaultBrandShortName               = "OVINC"
	defaultBrandDescription             = "OVINC Chat is a multi-model AI conversation system."
	defaultBrandFaviconURL              = "/favicon.png"
